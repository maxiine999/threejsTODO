...
export default function App() {
  ...
  return (
    ...
    <animated.div className="container" style={{ backgroundColor: x.to([0, 1], ["#F7BAD3 ", "#EE8EA5"]), color: x.to([0, 1], ["#F9F6F2", "#c70f46"]) }}>
    <TodoWrapper />
      <h1 className="open upper" children="<todolist>" />
      <h1 className="close" children="</todolist>" />
      <animated.h1>{x.to((x) => (x + 99).toFixed(2))}</animated.h1>
